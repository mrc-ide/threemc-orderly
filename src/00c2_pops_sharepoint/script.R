#### Collating Population data for each country
...
readr::write_csv(
  ...
  pop_raw, paste0(save_dir, "pops_sharepoint.csv.gz")
)
readr::write_csv(
  zaf_pop, paste0(save_dir, "zaf_pops_sharepoint.csv.gz")
)
readr::write_csv(
  specpop, paste0(save_dir, "spectrum_pops_sharepoint.csv.gz")
)